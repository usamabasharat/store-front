...
from .models import Product, Collection, Review, Cart, CartItem, Customer, Order, OrderItem, ProductImages
...
class ProductSerializer(serializers.ModelSerializer):
  ...
  class Meta:
    ...
    fields = ['id', 'title', 'description', 'slug',
              'inventory', 'unit_price', 'price_with_tax', 'collection', 'images']
...
class CreateOrderSerializer(serializers.Serializer):
  ...
  def validate_cart_id(self, cart_id):
    if not Cart.objects.filter(pk=cart_id):
      raise serializers.ValidationError('Cart does not exist with given id.')
